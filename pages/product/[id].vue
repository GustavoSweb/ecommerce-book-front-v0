  ...
  <section class="flex flex-col w-full px-128 pt-64">
    <div class="items-start flex gap-128">
      ...
      <div>
        ...
        <div class="flex mt-32 gap-16">
          <div class="p-16 bg-[#F5F5F5]">
            <img src="/icons/Email.svg" alt="" class="h-32 w-32" />
          </div>
          <div
            class="py-16 px-32 bg-[#F5F5F5] text-body font-['Roboto'] flex items-center text-c5"
          >
            <h6>Entrega instantânea</h6>
          </div>
        </div>
      </div>
    </div>
    <div class="flex w-full gap-16 items-center mt-16">
      ...
      <div class="flex items-center gap-32">
        ...
        />
        <div>
          <p class="text-c5 font-['Roboto'] text-body">
            <span class="text-[#10633E]"
              ><i class="fa-solid fa-plus fa-2xs mr-[4px]"></i>200 pessoas
              compraram</span
            ><br />nos últimos meses
          </p>
        </div>
      </div>
    </div>
